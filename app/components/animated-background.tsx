...
import { Section, getKeyboardState } from "@/config/animated-background-config";
...
const AnimatedBackground = () => {
  ...
  const setupScrollAnimations = () => {
    ...
    createSectionTimeline("#features", "features", "about", "top 70%");
    createSectionTimeline("#how-it-works", "how-it-works", "features", "top 30%");
  };
  ...
  useEffect(() => {
    ...
    const manageAnimations = async () => {
      ...
      // Handle How-It-Works Section Animations
