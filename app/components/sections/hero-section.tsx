      ...
      <div className="container mx-auto px-6 md:px-10 z-10">
        <div className="max-w-3xl">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            <Button
              size="lg"
              className="h-14 px-8 text-lg font-semibold text-white bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 shadow-[0_15px_40px_rgba(79,70,229,0.5)] hover:shadow-[0_20px_50px_rgba(79,70,229,0.7)] hover:brightness-110 active:scale-95 transition-all cursor-pointer"
            ...
            <Button
              size="lg"
              variant="secondary"
              className="h-14 px-8 text-lg font-semibold bg-white/10 text-white border border-white/20 backdrop-blur-md hover:bg-white/15 hover:border-white/30 shadow-[0_10px_35px_rgba(0,0,0,0.4)] active:scale-95 transition-all cursor-pointer"
